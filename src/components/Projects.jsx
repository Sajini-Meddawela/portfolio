...
export const Projects = () => {
    const projects = [
        {
            ...
            description: "Role Base User Authentication and Authorization with Chat based user Interaction.2nd year software development project",
            imgUrl: project1,
        },
        {
  ...
  return (
      <section className="project" id="projects">
                                  ...
                                  <Tab.Container id="projects-tabs" defaultActiveKey="first">
                                      ...
                                      <Tab.Content>
                                          <Tab.Pane eventKey="first">
                                              <p>Welcome to my portfolio of projects! Here, you'll find a collection of my most significant and recent work, showcasing my skills and experience in web development, design. Each project reflects my dedication to learning and applying new technologies, solving complex problems, and delivering high-quality, user-friendly applications. Explore my projects below and visit my GitHub for more details.</p>
                                              <Row>
                                                  {
                                          ...
                                          <Tab.Pane eventKey="second">
                                              <p className="technology-description">
                                                  Though I'm not yet an expert in these technologies, I've gained a foundational understanding through my studies and self-driven exploration. I am deeply committed to advancing my skills and continuously learning more about these tools. My journey with these technologies is ongoing, and this collection represents my current capabilities and my dedication to becoming proficient in each of these areas.
                                              </p>
                                              <Row>
                                                  {techImages.map((tech, index) => (
                                                      <Col key={index} xs={4} md={3} lg={2} className="tech-col">
                                                          <TrackVisibility>
                                                              {({ isVisible }) =>
                                          ...
                                          <Tab.Pane eventKey="third">
                                              ...
                                              <div className="d-flex justify-content-center">
                                                    <button onClick={handleLinkedInRedirect}>
                                                              Refer My LinkedIn For More Certifications <ArrowRightCircle size={25} />
                                                    </button>
                                              </div>
                                          </Tab.Pane>
                                      </Tab.Content>
          ...
          <img className="background-image-right" src={shade2} alt="background"></img>
      </section>
  )
}